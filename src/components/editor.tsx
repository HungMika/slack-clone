...
const Editor = ({
  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        className={cn(
          "flex flex-col border border-slate-200 rounded-e overflow-hidden focus-within:border-slate-300 focus-within:shadow-sm transition bg-white",
          disabled && "opacity-50",
        )}
      >
            ...
            <div className="relative size-[62px] flex items-center justify-center group/image">
              <Hint label="remove image">
                <button
                  ...
                  className="
                hidden group-hover/image:flex rounded-full bg-black/70 hover:bg-black absolute 
